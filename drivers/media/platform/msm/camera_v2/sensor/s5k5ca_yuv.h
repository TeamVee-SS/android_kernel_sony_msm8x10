...
// 00.History
//==================================================================================
// Ver 0.1 Nnalog Settings for 5CA EVT0 30FPS in Binning, including latest TnP
// for EVT1
// 20091310 : ded analog settings for 430LSB, long exposure mode only. Settings
// are for 32MHz Sys. CLK
// 20091102 : ded all calibration data, final settings for STW EVT1 module, SCLK
// 32MHz, PCLK 60 MHz.
...
//=================================================================================
// Start T&P part
// DO NOT DELETE T&P SECTION COMMENTS! They are required to debug T&P related
// issues.
...
//
{0x0028, 0x7000}, {0x002A, 0x2CF8}, {0x0F12, 0xB570}, {0x0F12, 0x4828},
    {0x0F12, 0x21C0}, {0x0F12, 0x8041}, {0x0F12, 0x4826}, {0x0F12, 0x4A27},
    {0x0F12, 0x3020}, {0x0F12, 0x8382}, {0x0F12, 0x1D12}, {0x0F12, 0x83C2},
    {0x0F12, 0x4823}, {0x0F12, 0x3040}, {0x0F12, 0x8041}, {0x0F12, 0x4822},
    {0x0F12, 0x4923}, {0x0F12, 0x3060}, {0x0F12, 0x8381}, {0x0F12, 0x1D09},
    {0x0F12, 0x83C1}, {0x0F12, 0x4822}, {0x0F12, 0x491E}, {0x0F12, 0x8802},
    {0x0F12, 0x3980}, {0x0F12, 0x804A}, {0x0F12, 0x8842}, {0x0F12, 0x808A},
    {0x0F12, 0x8882}, {0x0F12, 0x80CA}, {0x0F12, 0x88C2}, {0x0F12, 0x810A},
    {0x0F12, 0x8902}, {0x0F12, 0x491D}, {0x0F12, 0x80CA}, {0x0F12, 0x8942},
    {0x0F12, 0x814A}, {0x0F12, 0x8982}, {0x0F12, 0x830A}, {0x0F12, 0x89C2},
    {0x0F12, 0x834A}, {0x0F12, 0x8A00}, {0x0F12, 0x4919}, {0x0F12, 0x8188},
    {0x0F12, 0x4919}, {0x0F12, 0x481A}, {0x0F12, 0xF000}, {0x0F12, 0xF9FC},
    {0x0F12, 0x4819}, {0x0F12, 0x4D1A}, {0x0F12, 0x6028}, {0x0F12, 0x491A},
    {0x0F12, 0x0028}, {0x0F12, 0x3080}, {0x0F12, 0x6341}, {0x0F12, 0x4919},
    {0x0F12, 0x4819}, {0x0F12, 0xF000}, {0x0F12, 0xF9F1}, {0x0F12, 0x4919},
    {0x0F12, 0x0028}, {0x0F12, 0x3040}, {0x0F12, 0x62C1}, {0x0F12, 0x4818},
    {0x0F12, 0x002C}, {0x0F12, 0x3C40}, {0x0F12, 0x63E0}, {0x0F12, 0x4817},
    {0x0F12, 0x6320}, {0x0F12, 0x4817}, {0x0F12, 0x61A8}, {0x0F12, 0x4917},
    {0x0F12, 0x4817}, {0x0F12, 0xF000}, {0x0F12, 0xF9E1}, {0x0F12, 0x4917},
    {0x0F12, 0x4817}, {0x0F12, 0xF000}, {0x0F12, 0xF9DD}, {0x0F12, 0x4817},
    {0x0F12, 0x62A0}, {0x0F12, 0xBC70}, {0x0F12, 0xBC08}, {0x0F12, 0x4718},
    {0x0F12, 0x1100}, {0x0F12, 0xD000}, {0x0F12, 0x267C}, {0x0F12, 0x0000},
    {0x0F12, 0x3904}, {0x0F12, 0x0000}, {0x0F12, 0x3274}, {0x0F12, 0x7000},
    {0x0F12, 0xF400}, {0x0F12, 0xD000}, {0x0F12, 0xF520}, {0x0F12, 0xD000},
    {0x0F12, 0x2DF5}, {0x0F12, 0x7000}, {0x0F12, 0x89A9}, {0x0F12, 0x0000},
    {0x0F12, 0x2E47}, {0x0F12, 0x7000}, {0x0F12, 0x00C0}, {0x0F12, 0x7000},
    {0x0F12, 0x2E6F}, {0x0F12, 0x7000}, {0x0F12, 0x2EA5}, {0x0F12, 0x7000},
    {0x0F12, 0xB4F7}, {0x0F12, 0x0000}, {0x0F12, 0x2F2F}, {0x0F12, 0x7000},
    {0x0F12, 0x2F53}, {0x0F12, 0x7000}, {0x0F12, 0x2FF9}, {0x0F12, 0x7000},
    {0x0F12, 0x300D}, {0x0F12, 0x7000}, {0x0F12, 0x2FE1}, {0x0F12, 0x7000},
    {0x0F12, 0x013D}, {0x0F12, 0x0001}, {0x0F12, 0x3093}, {0x0F12, 0x7000},
    {0x0F12, 0x5823}, {0x0F12, 0x0000}, {0x0F12, 0x30E1}, {0x0F12, 0x7000},
    {0x0F12, 0xB570}, {0x0F12, 0x6804}, {0x0F12, 0x6845}, {0x0F12, 0x6881},
    {0x0F12, 0x6840}, {0x0F12, 0x2900}, {0x0F12, 0x6880}, {0x0F12, 0xD007},
    {0x0F12, 0x49BA}, {0x0F12, 0x8949}, {0x0F12, 0x084A}, {0x0F12, 0x1880},
    {0x0F12, 0xF000}, {0x0F12, 0xF9A6}, {0x0F12, 0x80A0}, {0x0F12, 0xE000},
    {0x0F12, 0x80A0}, {0x0F12, 0x88A0}, {0x0F12, 0x2800}, {0x0F12, 0xD010},
    {0x0F12, 0x68A9}, {0x0F12, 0x6828}, {0x0F12, 0x084A}, {0x0F12, 0x1880},
    {0x0F12, 0xF000}, {0x0F12, 0xF99A}, {0x0F12, 0x8020}, {0x0F12, 0x1D2D},
    {0x0F12, 0xCD03}, {0x0F12, 0x084A}, {0x0F12, 0x1880}, {0x0F12, 0xF000},
    {0x0F12, 0xF993}, {0x0F12, 0x8060}, {0x0F12, 0xBC70}, {0x0F12, 0xBC08},
    {0x0F12, 0x4718}, {0x0F12, 0x2000}, {0x0F12, 0x8060}, {0x0F12, 0x8020},
    {0x0F12, 0xE7F8}, {0x0F12, 0xB510}, {0x0F12, 0xF000}, {0x0F12, 0xF98E},
    {0x0F12, 0x49A9}, {0x0F12, 0x8A08}, {0x0F12, 0x6889}, {0x0F12, 0x4348},
    {0x0F12, 0x49A8}, {0x0F12, 0x0080}, {0x0F12, 0xF000}, {0x0F12, 0xF980},
    {0x0F12, 0x213F}, {0x0F12, 0x283F}, {0x0F12, 0xD200}, {0x0F12, 0x0001},
    {0x0F12, 0x48A5}, {0x0F12, 0x8141}, {0x0F12, 0xBC10}, {0x0F12, 0xBC08},
    {0x0F12, 0x4718}, {0x0F12, 0xB510}, {0x0F12, 0xF000}, {0x0F12, 0xF982},
    {0x0F12, 0x48A2}, {0x0F12, 0x8A40}, {0x0F12, 0x2800}, {0x0F12, 0xD0F5},
    {0x0F12, 0x48A1}, {0x0F12, 0x49A2}, {0x0F12, 0x8800}, {0x0F12, 0x4AA2},
    {0x0F12, 0x2805}, {0x0F12, 0xD003}, {0x0F12, 0x4BA1}, {0x0F12, 0x795B},
    {0x0F12, 0x2B00}, {0x0F12, 0xD003}, {0x0F12, 0x2001}, {0x0F12, 0x8008},
    {0x0F12, 0x8010}, {0x0F12, 0xE7E7}, {0x0F12, 0x2800}, {0x0F12, 0xD1E5},
    {0x0F12, 0x2000}, {0x0F12, 0x8008}, {0x0F12, 0x8010}, {0x0F12, 0xE7E1},
    {0x0F12, 0xB5F8}, {0x0F12, 0x2407}, {0x0F12, 0x2C06}, {0x0F12, 0xD035},
    {0x0F12, 0x2C07}, {0x0F12, 0xD033}, {0x0F12, 0x4894}, {0x0F12, 0x8BC1},
    {0x0F12, 0x2900}, {0x0F12, 0xD02A}, {0x0F12, 0x00A2}, {0x0F12, 0x1815},
    {0x0F12, 0x4A95}, {0x0F12, 0x6DEE}, {0x0F12, 0x8A92}, {0x0F12, 0x4296},
    {0x0F12, 0xD923}, {0x0F12, 0x0028}, {0x0F12, 0x3080}, {0x0F12, 0x0007},
    {0x0F12, 0x69C0}, {0x0F12, 0xF000}, {0x0F12, 0xF945}, {0x0F12, 0x1C71},
    {0x0F12, 0x0280}, {0x0F12, 0xF000}, {0x0F12, 0xF941}, {0x0F12, 0x0006},
    {0x0F12, 0x4889}, {0x0F12, 0x0061}, {0x0F12, 0x1808}, {0x0F12, 0x8D80},
    {0x0F12, 0x0A01}, {0x0F12, 0x0600}, {0x0F12, 0x0E00}, {0x0F12, 0x1A08},
    {0x0F12, 0xF000}, {0x0F12, 0xF94C}, {0x0F12, 0x0002}, {0x0F12, 0x6DE9},
    {0x0F12, 0x6FE8}, {0x0F12, 0x1A08}, {0x0F12, 0x4351}, {0x0F12, 0x0300},
    {0x0F12, 0x1C49}, {0x0F12, 0xF000}, {0x0F12, 0xF92D}, {0x0F12, 0x0401},
    {0x0F12, 0x0430}, {0x0F12, 0x0C00}, {0x0F12, 0x4301}, {0x0F12, 0x61F9},
    {0x0F12, 0xE004}, {0x0F12, 0x00A2}, {0x0F12, 0x4981}, {0x0F12, 0x1810},
    {0x0F12, 0x3080}, {0x0F12, 0x61C1}, {0x0F12, 0x1E64}, {0x0F12, 0xD2C5},
    {0x0F12, 0x2006}, {0x0F12, 0xF000}, {0x0F12, 0xF93B}, {0x0F12, 0x2007},
    {0x0F12, 0xF000}, {0x0F12, 0xF938}, {0x0F12, 0xBCF8}, {0x0F12, 0xBC08},
    {0x0F12, 0x4718}, {0x0F12, 0xB510}, {0x0F12, 0xF000}, {0x0F12, 0xF93A},
    {0x0F12, 0x2800}, {0x0F12, 0xD00A}, {0x0F12, 0x4872}, {0x0F12, 0x8B81},
    {0x0F12, 0x0089}, {0x0F12, 0x1808}, {0x0F12, 0x6DC1}, {0x0F12, 0x4874},
    {0x0F12, 0x8A80}, {0x0F12, 0x4281}, {0x0F12, 0xD901}, {0x0F12, 0x2001},
    {0x0F12, 0xE78C}, {0x0F12, 0x2000}, {0x0F12, 0xE78A}, {0x0F12, 0xB5F8},
    {0x0F12, 0x0004}, {0x0F12, 0x4F71}, {0x0F12, 0x227D}, {0x0F12, 0x8938},
    {0x0F12, 0x0152}, {0x0F12, 0x4342}, {0x0F12, 0x486F}, {0x0F12, 0x9000},
    {0x0F12, 0x8A01}, {0x0F12, 0x0848}, {0x0F12, 0x1810}, {0x0F12, 0xF000},
    {0x0F12, 0xF8F7}, {0x0F12, 0x210F}, {0x0F12, 0xF000}, {0x0F12, 0xF922},
    {0x0F12, 0x496B}, {0x0F12, 0x8C49}, {0x0F12, 0x090E}, {0x0F12, 0x0136},
    {0x0F12, 0x4306}, {0x0F12, 0x496A}, {0x0F12, 0x2C00}, {0x0F12, 0xD003},
    {0x0F12, 0x2001}, {0x0F12, 0x0240}, {0x0F12, 0x4330}, {0x0F12, 0x8108},
    {0x0F12, 0x4859}, {0x0F12, 0x2C00}, {0x0F12, 0x8D00}, {0x0F12, 0xD001},
    {0x0F12, 0x2501}, {0x0F12, 0xE000}, {0x0F12, 0x2500}, {0x0F12, 0x4963},
    {0x0F12, 0x4328}, {0x0F12, 0x8008}, {0x0F12, 0x207D}, {0x0F12, 0x00C0},
    {0x0F12, 0xF000}, {0x0F12, 0xF910}, {0x0F12, 0x2C00}, {0x0F12, 0x495F},
    {0x0F12, 0x0328}, {0x0F12, 0x4330}, {0x0F12, 0x8108}, {0x0F12, 0x88F8},
    {0x0F12, 0x2C00}, {0x0F12, 0x01AA}, {0x0F12, 0x4310}, {0x0F12, 0x8088},
    {0x0F12, 0x9800}, {0x0F12, 0x8A01}, {0x0F12, 0x485A}, {0x0F12, 0xF000},
    {0x0F12, 0xF8CB}, {0x0F12, 0x495A}, {0x0F12, 0x8809}, {0x0F12, 0x4348},
    {0x0F12, 0x0400}, {0x0F12, 0x0C00}, {0x0F12, 0xF000}, {0x0F12, 0xF8FA},
    {0x0F12, 0x0020}, {0x0F12, 0xF000}, {0x0F12, 0xF8FF}, {0x0F12, 0x4856},
    {0x0F12, 0x7004}, {0x0F12, 0xE7A3}, {0x0F12, 0xB510}, {0x0F12, 0x0004},
    {0x0F12, 0xF000}, {0x0F12, 0xF900}, {0x0F12, 0x6020}, {0x0F12, 0x4953},
    {0x0F12, 0x8B49}, {0x0F12, 0x0789}, {0x0F12, 0xD001}, {0x0F12, 0x0040},
    {0x0F12, 0x6020}, {0x0F12, 0xE737}, {0x0F12, 0xB510}, {0x0F12, 0xF000},
    {0x0F12, 0xF8FD}, {0x0F12, 0x484F}, {0x0F12, 0x8880}, {0x0F12, 0x0601},
    {0x0F12, 0x4845}, {0x0F12, 0x1609}, {0x0F12, 0x8141}, {0x0F12, 0xE72D},
    {0x0F12, 0xB5F8}, {0x0F12, 0x000F}, {0x0F12, 0x4C38}, {0x0F12, 0x3420},
    {0x0F12, 0x2500}, {0x0F12, 0x5765}, {0x0F12, 0x0039}, {0x0F12, 0xF000},
    {0x0F12, 0xF8F5}, {0x0F12, 0x9000}, {0x0F12, 0x2600}, {0x0F12, 0x57A6},
    {0x0F12, 0x4C3D}, {0x0F12, 0x42AE}, {0x0F12, 0xD01B}, {0x0F12, 0x4D44},
    {0x0F12, 0x8AE8}, {0x0F12, 0x2800}, {0x0F12, 0xD013}, {0x0F12, 0x4830},
    {0x0F12, 0x8A01}, {0x0F12, 0x8B80}, {0x0F12, 0x4378}, {0x0F12, 0xF000},
    {0x0F12, 0xF88F}, {0x0F12, 0x89A9}, {0x0F12, 0x1A41}, {0x0F12, 0x483E},
    {0x0F12, 0x3820}, {0x0F12, 0x8AC0}, {0x0F12, 0x4348}, {0x0F12, 0x17C1},
    {0x0F12, 0x0D89}, {0x0F12, 0x1808}, {0x0F12, 0x1280}, {0x0F12, 0x8961},
    {0x0F12, 0x1A08}, {0x0F12, 0x8160}, {0x0F12, 0xE003}, {0x0F12, 0x88A8},
    {0x0F12, 0x0600}, {0x0F12, 0x1600}, {0x0F12, 0x8160}, {0x0F12, 0x200A},
    {0x0F12, 0x5E20}, {0x0F12, 0x42B0}, {0x0F12, 0xD011}, {0x0F12, 0xF000},
    {0x0F12, 0xF88D}, {0x0F12, 0x1D40}, {0x0F12, 0x00C3}, {0x0F12, 0x1A18},
    {0x0F12, 0x214B}, {0x0F12, 0xF000}, {0x0F12, 0xF871}, {0x0F12, 0x211F},
    {0x0F12, 0xF000}, {0x0F12, 0xF89C}, {0x0F12, 0x210A}, {0x0F12, 0x5E61},
    {0x0F12, 0x0FC9}, {0x0F12, 0x0149}, {0x0F12, 0x4301}, {0x0F12, 0x481C},
    {0x0F12, 0x81C1}, {0x0F12, 0x9800}, {0x0F12, 0xE74A}, {0x0F12, 0xB5F1},
    {0x0F12, 0xB082}, {0x0F12, 0x2500}, {0x0F12, 0x4829}, {0x0F12, 0x9001},
    {0x0F12, 0x2400}, {0x0F12, 0x2028}, {0x0F12, 0x4368}, {0x0F12, 0x4A28},
    {0x0F12, 0x4916}, {0x0F12, 0x1887}, {0x0F12, 0x1840}, {0x0F12, 0x9000},
    {0x0F12, 0x9800}, {0x0F12, 0x0066}, {0x0F12, 0x9A01}, {0x0F12, 0x1980},
    {0x0F12, 0x218C}, {0x0F12, 0x5A09}, {0x0F12, 0x8A80}, {0x0F12, 0x8812},
    {0x0F12, 0xF000}, {0x0F12, 0xF8AC}, {0x0F12, 0x53B8}, {0x0F12, 0x1C64},
    {0x0F12, 0x2C14}, {0x0F12, 0xDBF1}, {0x0F12, 0x1C6D}, {0x0F12, 0x2D03},
    {0x0F12, 0xDBE6}, {0x0F12, 0x9802}, {0x0F12, 0x6800}, {0x0F12, 0x0600},
    {0x0F12, 0x0E00}, {0x0F12, 0xF000}, {0x0F12, 0xF8A7}, {0x0F12, 0xBCFE},
    {0x0F12, 0xBC08}, {0x0F12, 0x4718}, {0x0F12, 0xB510}, {0x0F12, 0x4B19},
    {0x0F12, 0x2200}, {0x0F12, 0x801A}, {0x0F12, 0xF000}, {0x0F12, 0xF8A6},
    {0x0F12, 0xE6BC}, {0x0F12, 0x0000}, {0x0F12, 0x0C3C}, {0x0F12, 0x7000},
    {0x0F12, 0x2C2C}, {0x0F12, 0x7000}, {0x0F12, 0xC824}, {0x0F12, 0x0031},
    {0x0F12, 0xF2A0}, {0x0F12, 0xD000}, {0x0F12, 0x3274}, {0x0F12, 0x7000},
    {0x0F12, 0x26E8}, {0x0F12, 0x7000}, {0x0F12, 0x6100}, {0x0F12, 0xD000},
    {0x0F12, 0x6500}, {0x0F12, 0xD000}, {0x0F12, 0x1A7C}, {0x0F12, 0x7000},
    {0x0F12, 0x1120}, {0x0F12, 0x7000}, {0x0F12, 0xFFFF}, {0x0F12, 0x0000},
    {0x0F12, 0x3374}, {0x0F12, 0x7000}, {0x0F12, 0x1D6C}, {0x0F12, 0x7000},
    {0x0F12, 0x167C}, {0x0F12, 0x7000}, {0x0F12, 0xF400}, {0x0F12, 0xD000},
    {0x0F12, 0x40A0}, {0x0F12, 0x00DD}, {0x0F12, 0xF520}, {0x0F12, 0xD000},
    {0x0F12, 0x2C29}, {0x0F12, 0x7000}, {0x0F12, 0x1A54}, {0x0F12, 0x7000},
    {0x0F12, 0x1564}, {0x0F12, 0x7000}, {0x0F12, 0x2440}, {0x0F12, 0x7000},
    {0x0F12, 0x05A0}, {0x0F12, 0x7000}, {0x0F12, 0xB0A0}, {0x0F12, 0xD000},
    {0x0F12, 0x4778}, {0x0F12, 0x46C0}, {0x0F12, 0xC000}, {0x0F12, 0xE59F},
    {0x0F12, 0xFF1C}, {0x0F12, 0xE12F}, {0x0F12, 0x1A3F}, {0x0F12, 0x0001},
    {0x0F12, 0x4778}, {0x0F12, 0x46C0}, {0x0F12, 0xF004}, {0x0F12, 0xE51F},
    {0x0F12, 0x1F48}, {0x0F12, 0x0001}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xF7C1}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x24BD}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x36DD}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xB4CF}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xB5D7}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x36ED}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xF53F}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xF5D9}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x013D}, {0x0F12, 0x0001}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xF5C9}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0xFAA9}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x3723}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x5823}, {0x0F12, 0x0000}, {0x0F12, 0x4778}, {0x0F12, 0x46C0},
    {0x0F12, 0xC000}, {0x0F12, 0xE59F}, {0x0F12, 0xFF1C}, {0x0F12, 0xE12F},
    {0x0F12, 0x1857}, {0x0F12, 0x0001}, {0x0F12, 0x9F9E}, {0x0F12, 0x0000},
    //
    ...
    {0x002A, 0x157A}, {0x0F12, 0x0001}, {0x002A, 0x1578}, {0x0F12, 0x0001},
    {0x002A, 0x1576}, {0x0F12, 0x0020}, {0x002A, 0x1574}, {0x0F12, 0x0006},
    {0x002A, 0x156E},
    {0x0F12, 0x0001}, // slope calibration tolerance in units of 1/256
    {0x002A, 0x1568}, {0x0F12, 0x00FC},
    ...
    {0x002A, 0x157C}, {0x0F12, 0x0190}, // 400 Reset ramp for x1 in DCLK counts
    {0x002A, 0x1570}, {0x0F12, 0x00A0}, // 160 LsB
    {0x0F12, 0x0010},			// reset threshold
    {0x002A, 0x12C4}, {0x0F12, 0x006A}, // 106 additional timing columns.
    {0x002A, 0x12C8},
    {0x0F12, 0x08AC}, // 2220 ADC columns in normal mode including Hold & Latch
    {0x0F12,
     0x0050}, // 80 addition of ADC columns in Y-ave mode (default 244 0x74)
    ...
    {0x002A, 0x1690}, // when set double sampling is activated - requires
    ...
    {0x002A,
     0x337A}, // [7] - is used for rest-only mode (EVT0 value is 0xD and HW 0x6)
    {0x0F12, 0x0006},
    {0x0F12, 0x0068}, {0x002A, 0x169E}, {0x0F12, 0x0007}, {0x002A, 0x0BF6},
    {0x0F12, 0x0000},

    {0x002A, 0x327C}, {0x0F12, 0x1000}, {0x0F12, 0x6998}, {0x0F12, 0x0078},
    {0x0F12, 0x04FE}, {0x0F12, 0x8800},

    {0x002A, 0x3274}, {0x0F12, 0x0155}, // set IO driving current 2mA for Gs500
    {0x0F12, 0x0155},			// set IO driving current
    {0x0F12, 0x1555},			// set IO driving current
    {0x0F12, 0x0555},			// set IO driving current

    {0x0028, 0x7000}, {0x002A, 0x0572},
    {0x0F12, 0x0007}, //#skl_usConfigStbySettings // Enable T&P code after HW
		      //stby + skip ZI part on HW wakeup.

    {0x0028, 0x7000}, {0x002A, 0x12D2},
    ...
    // s002A01E8
    // s0F122A0C //REG_TC_IPRM_CM_Init_Mi2cBits : MSCL - GPIO1 MSDA - GPIO2
    // Device ID (0C)
    ...
    //// AF Policy
    // s002A10E2
    // s0F120000 //#af_search_usCapturePolicy: Focus_Priority, 0002 :
    // Shutter_Priority_Fixed, 0001 : Shutter_Priority_Last_BFP 0000:
    // Shutter_Priority_Current
    // s002A1072
    ...
    // If you change it without prior notification
    // YOU are RESPONSIBLE for the FAILURE that will happen in the future
    {0x002A, 0x158A}, {0x0F12, 0xEAF0}, {0x002A, 0x15C6}, {0x0F12, 0x0020},
    {0x0F12, 0x0060}, {0x002A, 0x15BC}, {0x0F12, 0x0200},

    {0x002A, 0x1608}, {0x0F12, 0x0100}, {0x0F12, 0x0100}, {0x0F12, 0x0100},
    {0x0F12, 0x0100},

    //==================================================================================
    // 06.AE Setting
    //==================================================================================
    {0x002A, 0x0F70}, {0x0F12, 0x003A}, // 36 //TVAR_ae_BrAve  //ae Target//
    {0x002A, 0x0530}, {0x0F12, 0x3A98}, // #lt_uMaxExp1    30ms
    {0x0F12, 0x0000}, {0x0F12, 0x7EF4}, // #lt_uMaxExp2    65ms
    {0x0F12, 0x0000}, {0x002A, 0x167C},
    {0x0F12, 0x9C40},			// #evt1_lt_uMaxExp3  80ms
    {0x0F12, 0x0000}, {0x0F12, 0xF424}, // #evt1_lt_uMaxExp4  125ms
    {0x0F12, 0x0000},

    // Set capture, exposure time
    {0x002A, 0x0538}, {0x0F12, 0x3A98}, // #lt_uCapMaxExp1   30ms
    {0x0F12, 0x0000}, {0x0F12, 0x7EF4}, // #lt_uCapMaxExp2      65ms
    {0x0F12, 0x0000}, {0x002A, 0x1684},
    {0x0F12, 0x9C40},			// #evt1_lt_uCapMaxExp3 80ms
    {0x0F12, 0x0000}, {0x0F12, 0xF424}, // #evt1_lt_uCapMaxExp4 125ms
    {0x0F12, 0x0000},

    // Set gain
    {0x002A, 0x0540}, {0x0F12, 0x0170}, // 0320 // #lt_uMaxAnGain1
    {0x0F12, 0x0250},			// 0380 // #lt_uMaxAnGain2
    {0x002A, 0x168C}, {0x0F12, 0x0380}, // 0500 // #evt1_lt_uMaxAnGain3
    {0x0F12, 0x0800},			// 0800 // #evt1_lt_uMaxAnGain4

    {0x002A, 0x0544}, {0x0F12, 0x0100}, // #lt_uMaxDigGain
    {0x0F12, 0x0800},			// #lt_uMaxTotGain

    {0x002A, 0x0544}, {0x0F12, 0x0100}, {0x0F12, 0x8000}, // Max Gain 8 //

    {0x002A, 0x1694}, {0x0F12, 0x0001}, // expand forbidde zone //

    {0x002A, 0x021A}, {0x0F12, 0x0000}, // MBR off//

    //==================================================================================
    // 07.Auto Flicker Detection
    //==================================================================================
    {0x002A, 0x04D2}, {0x0F12, 0x067F}, {0x002A, 0x0C18}, {0x0F12, 0x0001},
    // s002A0C04
    // s0F12FFFF
    ...
    // 08.Gas_Anti Shading
    //==================================================================================
    {0x002A, 0x06CE}, {0x0F12, 0x00FD}, // TVAR_ash_GAsalpha[0] //
    ...
    // GAS LUT
    {0x002A, 0x347C}, {0x0F12, 0x0220}, //#TVAR_ash_pGAS[0]
    ...
    {0x002A, 0x074E}, {0x0F12, 0x0000}, // ash_bLumaMode //
    {0x002A, 0x0D30}, {0x0F12, 0x02A7}, // awbb_GLocusR //
    {0x0F12, 0x0343},			// awbb_GLocusB //

    // param_start TVAR_ash_AwbAshCord
    {0x002A, 0x06B8}, {0x0F12, 0x00C7}, // 00C0//00D0 // #TVAR_ash_AwbAshCord_0_
    ...
    {0x002A, 0x0664}, {0x0F12, 0x013E}, // seti_uContrastCenter //

    {0x002A, 0x06C6}, {0x0F12, 0x0100}, // ash_CGrasalphaS[0] //
    ...
    {0x0F12, 0x03B6}, // 03B6 //03C8 // #awbb_IndoorGrZones_m_BGrid[0] // Indoor
		      // boundary
    ...
    {0x002A, 0x0C9C}, {0x0F12, 0x0010}, // #awbb_IndoorGrZones_ZInfo_m_GridSz
    {0x002A, 0x0CA0}, {0x0F12, 0x00FE}, // #awbb_IndoorGrZones_m_Boffs[0]
    ...
    {0x002A, 0x0D14}, {0x0F12, 0x000B}, // #awbb_LowBrGrZones_ZInfo_m_GridSz
    {0x002A, 0x0D18}, {0x0F12, 0x009A}, // #awbb_LowBrGrZones_m_Boffs

    {0x002A, 0x0CA4}, {0x0F12, 0x0218}, // 0290 //027E //
					// #awbb_OutdoorGrZones_m_BGrid[0] //
					// Outdoor boundary
    ...
    {0x002A, 0x0CD8}, {0x0F12, 0x0006}, // #awbb_OutdoorGrZones_ZInfo_m_GridSz
    {0x002A, 0x0CDC}, {0x0F12, 0x022E}, // #awbb_OutdoorGrZones_m_Boffs

    {0x002A, 0x0D1C}, {0x0F12, 0x036C}, // #awbb_CrclLowT_R_c
    {0x002A, 0x0D20}, {0x0F12, 0x011C}, // #awbb_CrclLowT_B_c
    {0x002A, 0x0D24}, {0x0F12, 0x6184}, // #awbb_CrclLowT_Rad_c
    {0x002A, 0x0D2C}, {0x0F12, 0x0135}, // #awbb_IntcR
    {0x0F12, 0x012B},			// #awbb_IntcB
    {0x002A, 0x0D46}, {0x0F12, 0x04C0}, // #awbb_MvEq_RBthresh

    {0x002A, 0x0D28}, {0x0F12, 0x024E}, // #awbb_OutdoorWP_r
    {0x0F12, 0x027B},			// #awbb_OutdoorWP_b

    {0x002A, 0x0D5C}, {0x0F12, 0x7FFF}, // #awbb_LowTempRB
    {0x0F12, 0x0050},			// #awbb_LowTemp_RBzone

    {0x002A, 0x2316}, {0x0F12, 0x0006},
    ...
    {0x002A, 0x0E36}, {0x0F12, 0x0028}, // R OFFSET
    {0x0F12, 0xFFD8},			// B OFFSET
    {0x0F12, 0x0000},			// G OFFSET

    {0x002A, 0x0DD4}, {0x0F12, 0xFFFE}, // #awbb_GridCorr_R_0__0_
    ...
    {0x002A, 0x0E4A}, {0x0F12, 0x0002}, // awbb_GridEnable//

    {0x002A, 0x051A}, {0x0F12, 0x010E}, // lt_uLimitHigh//
    {0x0F12, 0x00F5},			// lt_uLimitLow//

    {0x002A, 0x0F76}, {0x0F12, 0x000F}, // ae_statmode BLC off : 0x0F, on :
					// 0x0D//  illumType On : 07 , Off : 0F

    {0x002A, 0x1034}, {0x0F12, 0x00C0}, // saRR_IllumType[0] //
    ...
    // 11.CCM Setting
    //==================================================================================
    {0x002A, 0x06A6}, {0x0F12, 0x00CA}, // #SARR_AwbCcmCord_0_
    ...
    {0x002A, 0x3380}, {0x0F12, 0x01E0}, //#TVAR_wbt_pOutdoorCcm[0]// Outdoor CCM
    ...
    {0x002A, 0x07C4}, {0x0F12, 0x0014}, {0x0F12, 0x0000}, {0x0F12, 0x0014},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00C4}, {0x0F12, 0x03FF},
    {0x0F12, 0x009C}, {0x0F12, 0x017C}, {0x0F12, 0x03FF}, {0x0F12, 0x000C},
    {0x0F12, 0x0010}, {0x0F12, 0x012C}, {0x0F12, 0x03E8}, {0x0F12, 0x0046},
    {0x0F12, 0x005A}, {0x0F12, 0x0070}, {0x0F12, 0x0019}, {0x0F12, 0x0019},
    {0x0F12, 0x01AA}, {0x0F12, 0x0064}, {0x0F12, 0x0064}, {0x0F12, 0x000A},
    {0x0F12, 0x000A}, {0x0F12, 0x0032}, {0x0F12, 0x0012}, {0x0F12, 0x002A},
    {0x0F12, 0x0024}, {0x0F12, 0x002A}, {0x0F12, 0x0024}, {0x0F12, 0x0A24},
    {0x0F12, 0x1701}, {0x0F12, 0x0229}, {0x0F12, 0x1403}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00FF}, {0x0F12, 0x043B},
    {0x0F12, 0x1414}, {0x0F12, 0x0301}, {0x0F12, 0xFF07}, {0x0F12, 0x051E},
    {0x0F12, 0x0A1E}, {0x0F12, 0x0F0F}, {0x0F12, 0x0A00}, {0x0F12, 0x0A3C},
    {0x0F12, 0x0A28}, {0x0F12, 0x0002}, {0x0F12, 0x00FF}, {0x0F12, 0x1102},
    {0x0F12, 0x001B}, {0x0F12, 0x0900}, {0x0F12, 0x0600}, {0x0F12, 0x0504},
    {0x0F12, 0x0305}, {0x0F12, 0x1E03}, {0x0F12, 0x0080}, {0x0F12, 0x0064},
    {0x0F12, 0x0080}, {0x0F12, 0x1414}, {0x0F12, 0x0101}, {0x0F12, 0x5002},
    {0x0F12, 0x7850}, {0x0F12, 0x2878}, {0x0F12, 0x0A00}, {0x0F12, 0x1403},
    {0x0F12, 0x1E0C}, {0x0F12, 0x070A}, {0x0F12, 0x32FF}, {0x0F12, 0x4104},
    {0x0F12, 0x123C}, {0x0F12, 0x4012}, {0x0F12, 0x0204}, {0x0F12, 0x1E03},
    {0x0F12, 0x011E}, {0x0F12, 0x0201}, {0x0F12, 0x5050}, {0x0F12, 0x3C3C},
    {0x0F12, 0x0028}, {0x0F12, 0x030A}, {0x0F12, 0x0714}, {0x0F12, 0x0A1E},
    {0x0F12, 0xFF07}, {0x0F12, 0x0432}, {0x0F12, 0x4050}, {0x0F12, 0x0F0F},
    {0x0F12, 0x0440}, {0x0F12, 0x0302}, {0x0F12, 0x1E1E}, {0x0F12, 0x0101},
    {0x0F12, 0x5002}, {0x0F12, 0x3C50}, {0x0F12, 0x283C}, {0x0F12, 0x0A00},
    {0x0F12, 0x1403}, {0x0F12, 0x1E07}, {0x0F12, 0x070A}, {0x0F12, 0x32FF},
    {0x0F12, 0x5004}, {0x0F12, 0x0F40}, {0x0F12, 0x400F}, {0x0F12, 0x0204},
    {0x0F12, 0x0003}, {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x0014},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00C4}, {0x0F12, 0x03FF},
    {0x0F12, 0x009C}, {0x0F12, 0x017C}, {0x0F12, 0x03FF}, {0x0F12, 0x000C},
    {0x0F12, 0x0010}, {0x0F12, 0x012C}, {0x0F12, 0x03E8}, {0x0F12, 0x0046},
    {0x0F12, 0x005A}, {0x0F12, 0x0070}, {0x0F12, 0x000F}, {0x0F12, 0x000F},
    {0x0F12, 0x01AA}, {0x0F12, 0x003C}, {0x0F12, 0x003C}, {0x0F12, 0x0005},
    {0x0F12, 0x0005}, {0x0F12, 0x0046}, {0x0F12, 0x0019}, {0x0F12, 0x002A},
    {0x0F12, 0x0024}, {0x0F12, 0x002A}, {0x0F12, 0x0024}, {0x0F12, 0x0A24},
    {0x0F12, 0x1701}, {0x0F12, 0x0229}, {0x0F12, 0x1403}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00FF}, {0x0F12, 0x043B},
    {0x0F12, 0x1414}, {0x0F12, 0x0301}, {0x0F12, 0xFF07}, {0x0F12, 0x051E},
    ...
    {0x0F12, 0x0A28}, {0x0F12, 0x0002}, {0x0F12, 0x00FF}, {0x0F12, 0x1102},
    {0x0F12, 0x001B}, {0x0F12, 0x0900}, {0x0F12, 0x0600}, {0x0F12, 0x0504},
    {0x0F12, 0x0305}, {0x0F12, 0x4603}, {0x0F12, 0x0080}, {0x0F12, 0x0080},
    {0x0F12, 0x0080}, {0x0F12, 0x1919}, {0x0F12, 0x0101}, {0x0F12, 0x3C02},
    {0x0F12, 0x643C}, {0x0F12, 0x2864}, {0x0F12, 0x0A00}, {0x0F12, 0x1403},
    {0x0F12, 0x1E0C}, {0x0F12, 0x070A}, {0x0F12, 0x32FF}, {0x0F12, 0x4104},
    {0x0F12, 0x123C}, {0x0F12, 0x4012}, {0x0F12, 0x0204}, {0x0F12, 0x1E03},
    {0x0F12, 0x011E}, {0x0F12, 0x0201}, {0x0F12, 0x3232}, {0x0F12, 0x3C3C},
    {0x0F12, 0x0028}, {0x0F12, 0x030A}, {0x0F12, 0x0714}, {0x0F12, 0x0A1E},
    {0x0F12, 0xFF07}, {0x0F12, 0x0432}, {0x0F12, 0x4050}, {0x0F12, 0x0F0F},
    {0x0F12, 0x0440}, {0x0F12, 0x0302}, {0x0F12, 0x1E1E}, {0x0F12, 0x0101},
    {0x0F12, 0x3202}, {0x0F12, 0x3C32}, {0x0F12, 0x283C}, {0x0F12, 0x0A00},
    {0x0F12, 0x1403}, {0x0F12, 0x1E07}, {0x0F12, 0x070A}, {0x0F12, 0x32FF},
    {0x0F12, 0x5004}, {0x0F12, 0x0F40}, {0x0F12, 0x400F}, {0x0F12, 0x0204},
    {0x0F12, 0x0003}, {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00C4}, {0x0F12, 0x03FF},
    {0x0F12, 0x009C}, {0x0F12, 0x017C}, {0x0F12, 0x03FF}, {0x0F12, 0x000C},
    {0x0F12, 0x0010}, {0x0F12, 0x012C}, {0x0F12, 0x03E8}, {0x0F12, 0x0046},
    {0x0F12, 0x0078}, {0x0F12, 0x0070}, {0x0F12, 0x0004}, {0x0F12, 0x0004},
    {0x0F12, 0x01AA}, {0x0F12, 0x001E}, {0x0F12, 0x001E}, {0x0F12, 0x0002},
    {0x0F12, 0x0002}, {0x0F12, 0x0064}, {0x0F12, 0x003C}, {0x0F12, 0x002A},
    {0x0F12, 0x0024}, {0x0F12, 0x002A}, {0x0F12, 0x0024}, {0x0F12, 0x0A24},
    {0x0F12, 0x1701}, {0x0F12, 0x0229}, {0x0F12, 0x1403}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00FF}, {0x0F12, 0x043B},
    {0x0F12, 0x1414}, {0x0F12, 0x0301}, {0x0F12, 0xFF07}, {0x0F12, 0x051E},
    {0x0F12, 0x0A1E}, {0x0F12, 0x0F0F}, {0x0F12, 0x0A00}, {0x0F12, 0x0A3C},
    {0x0F12, 0x0D2E}, {0x0F12, 0x0002}, {0x0F12, 0x00FF}, {0x0F12, 0x1102},
    {0x0F12, 0x001B}, {0x0F12, 0x0900}, {0x0F12, 0x0600}, {0x0F12, 0x0504},
    {0x0F12, 0x0305}, {0x0F12, 0x4602}, {0x0F12, 0x2880}, {0x0F12, 0x0080},
    {0x0F12, 0x0080}, {0x0F12, 0x2323}, {0x0F12, 0x0101}, {0x0F12, 0x2A02},
    {0x0F12, 0x3C2A}, {0x0F12, 0x283C}, {0x0F12, 0x0A00}, {0x0F12, 0x1403},
    {0x0F12, 0x1E0C}, {0x0F12, 0x070A}, {0x0F12, 0x32FF}, {0x0F12, 0x6E04},
    {0x0F12, 0x0F96}, {0x0F12, 0x400F}, {0x0F12, 0x0204}, {0x0F12, 0x2303},
    {0x0F12, 0x0123}, {0x0F12, 0x0201}, {0x0F12, 0x262A}, {0x0F12, 0x2C2C},
    {0x0F12, 0x0028}, {0x0F12, 0x030A}, {0x0F12, 0x0714}, {0x0F12, 0x0A1E},
    {0x0F12, 0xFF07}, {0x0F12, 0x0432}, {0x0F12, 0x4050}, {0x0F12, 0x0F0F},
    {0x0F12, 0x0440}, {0x0F12, 0x0302}, {0x0F12, 0x2323}, {0x0F12, 0x0101},
    {0x0F12, 0x2A02}, {0x0F12, 0x2C26}, {0x0F12, 0x282C}, {0x0F12, 0x0A00},
    {0x0F12, 0x1403}, {0x0F12, 0x1E07}, {0x0F12, 0x070A}, {0x0F12, 0x32FF},
    {0x0F12, 0x5004}, {0x0F12, 0x0F40}, {0x0F12, 0x400F}, {0x0F12, 0x0204},
    {0x0F12, 0x0003}, {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00C4}, {0x0F12, 0x03FF},
    {0x0F12, 0x009C}, {0x0F12, 0x017C}, {0x0F12, 0x03FF}, {0x0F12, 0x000C},
    {0x0F12, 0x0010}, {0x0F12, 0x00C8}, {0x0F12, 0x03E8}, {0x0F12, 0x0046},
    {0x0F12, 0x0082}, {0x0F12, 0x0070}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
    {0x0F12, 0x01AA}, {0x0F12, 0x001E}, {0x0F12, 0x001E}, {0x0F12, 0x0002},
    {0x0F12, 0x0002}, {0x0F12, 0x010E}, {0x0F12, 0x003C}, {0x0F12, 0x0032},
    {0x0F12, 0x0028}, {0x0F12, 0x0032}, {0x0F12, 0x0028}, {0x0F12, 0x0A24},
    {0x0F12, 0x1701}, {0x0F12, 0x0229}, {0x0F12, 0x1403}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00FF}, {0x0F12, 0x043B},
    {0x0F12, 0x1414}, {0x0F12, 0x0301}, {0x0F12, 0xFF07}, {0x0F12, 0x051E},
    {0x0F12, 0x0A1E}, {0x0F12, 0x0F0F}, {0x0F12, 0x0A00}, {0x0F12, 0x0A3C},
    {0x0F12, 0x173E}, {0x0F12, 0x0002}, {0x0F12, 0x00FF}, {0x0F12, 0x1002},
    {0x0F12, 0x001E}, {0x0F12, 0x0900}, {0x0F12, 0x0600}, {0x0F12, 0x0504},
    {0x0F12, 0x0305}, {0x0F12, 0x5002}, {0x0F12, 0x2880}, {0x0F12, 0x0080},
    {0x0F12, 0x0080}, {0x0F12, 0x2328}, {0x0F12, 0x0101}, {0x0F12, 0x2A02},
    {0x0F12, 0x2228}, {0x0F12, 0x2822}, {0x0F12, 0x0A00}, {0x0F12, 0x1903},
    {0x0F12, 0x1E0F}, {0x0F12, 0x070A}, {0x0F12, 0x32FF}, {0x0F12, 0xAA04},
    {0x0F12, 0x0F96}, {0x0F12, 0x400F}, {0x0F12, 0x0504}, {0x0F12, 0x2805},
    {0x0F12, 0x0123}, {0x0F12, 0x0201}, {0x0F12, 0x2024}, {0x0F12, 0x1C1C},
    {0x0F12, 0x0028}, {0x0F12, 0x030A}, {0x0F12, 0x0A0A}, {0x0F12, 0x0A2D},
    {0x0F12, 0xFF07}, {0x0F12, 0x0432}, {0x0F12, 0x4050}, {0x0F12, 0x0F0F},
    {0x0F12, 0x0440}, {0x0F12, 0x0302}, {0x0F12, 0x2328}, {0x0F12, 0x0101},
    {0x0F12, 0x3C02}, {0x0F12, 0x1C3C}, {0x0F12, 0x281C}, {0x0F12, 0x0A00},
    {0x0F12, 0x0A03}, {0x0F12, 0x2D0A}, {0x0F12, 0x070A}, {0x0F12, 0x32FF},
    {0x0F12, 0x5004}, {0x0F12, 0x0F40}, {0x0F12, 0x400F}, {0x0F12, 0x0204},
    {0x0F12, 0x0003}, {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00C4}, {0x0F12, 0x03FF},
    {0x0F12, 0x009C}, {0x0F12, 0x017C}, {0x0F12, 0x03FF}, {0x0F12, 0x000C},
    {0x0F12, 0x0010}, {0x0F12, 0x00C8}, {0x0F12, 0x028A}, {0x0F12, 0x0046},
    {0x0F12, 0x015E}, {0x0F12, 0x0070}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
    {0x0F12, 0x01AA}, {0x0F12, 0x0014}, {0x0F12, 0x0014}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0140}, {0x0F12, 0x003C}, {0x0F12, 0x0032},
    {0x0F12, 0x0023}, {0x0F12, 0x0023}, {0x0F12, 0x0032}, {0x0F12, 0x0A24},
    {0x0F12, 0x1701}, {0x0F12, 0x0229}, {0x0F12, 0x1403}, {0x0F12, 0x0000},
    {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x00FF}, {0x0F12, 0x043B},
    {0x0F12, 0x1414}, {0x0F12, 0x0301}, {0x0F12, 0xFF07}, {0x0F12, 0x051E},
    {0x0F12, 0x0A1E}, {0x0F12, 0x0606}, {0x0F12, 0x0A01}, {0x0F12, 0x143C},
    {0x0F12, 0x203E}, {0x0F12, 0x0002}, {0x0F12, 0x00FF}, {0x0F12, 0x1002},
    {0x0F12, 0x001E}, {0x0F12, 0x0900}, {0x0F12, 0x0600}, {0x0F12, 0x0504},
    {0x0F12, 0x0305}, {0x0F12, 0x5001}, {0x0F12, 0x2880}, {0x0F12, 0x0080},
    {0x0F12, 0x0080}, {0x0F12, 0x5050}, {0x0F12, 0x0101}, {0x0F12, 0x1C02},
    {0x0F12, 0x191C}, {0x0F12, 0x2819}, {0x0F12, 0x0A00}, {0x0F12, 0x1E03},
    {0x0F12, 0x1E0F}, {0x0F12, 0x0508}, {0x0F12, 0x32FF}, {0x0F12, 0xBE04},
    {0x0F12, 0x1496}, {0x0F12, 0x4015}, {0x0F12, 0x0604}, {0x0F12, 0x5006},
    {0x0F12, 0x0150}, {0x0F12, 0x0201}, {0x0F12, 0x1E1E}, {0x0F12, 0x1212},
    {0x0F12, 0x0028}, {0x0F12, 0x030A}, {0x0F12, 0x0A10}, {0x0F12, 0x0819},
    {0x0F12, 0xFF05}, {0x0F12, 0x0432}, {0x0F12, 0x4052}, {0x0F12, 0x1514},
    {0x0F12, 0x0440}, {0x0F12, 0x0302}, {0x0F12, 0x5050}, {0x0F12, 0x0101},
    {0x0F12, 0x1E02}, {0x0F12, 0x121E}, {0x0F12, 0x2812}, {0x0F12, 0x0A00},
    {0x0F12, 0x1003}, {0x0F12, 0x190A}, {0x0F12, 0x0508}, {0x0F12, 0x32FF},
    {0x0F12, 0x5204}, {0x0F12, 0x1440}, {0x0F12, 0x4015}, {0x0F12, 0x0204},
    {0x0F12, 0x0003},
    ...
    //==================================================================================
    // AE weight
    {0x002A, 0x0F7E}, {0x0F12, 0x0101}, // #ae_WeightTbl_16_0_
    ...
    {0x002A, 0x01CC}, {0x0F12, 0x5DC0}, // #REG_TC_IPRM_InClockLSBs
    ...
    {0x0F12,
     0x0001}, //#REG_TC_IPRM_NumberOfMipiLanes      // Number of MIPI Lane
    {0x002A, 0x01F6},
    ...
    // Update PLL
    {0x002A, 0x0208}, {0x0F12, 0x0001}, // #REG_TC_IPRM_InitParamsUpdated
    ...
    //==================================================================================
    {0x002A, 0x026C}, {0x0F12, 0x0280}, //#REG_0TC_PCFG_usWidth//640
    ...
    {0x0F12, 0x0052}, //#REG_0TC_PCFG_PVIMask //s0050 = FALSE in MSM6290 : s0052
		      //= TRUE in MSM6800 //reg 027A
    {0x002A, 0x027E}, {0x0F12, 0x0000}, //#REG_0TC_PCFG_usJpegPacketSize
    ...
    {0x002A, 0x02B2}, {0x0F12, 0x0000}, // REG_1TC_PCFG_uClockInd
    ...
    {0x002A, 0x02CC}, {0x0F12, 0x0280}, // REG_2TC_PCFG_usWidth
    ...
    {0x002A, 0x035C}, {0x0F12, 0x0000}, //#REG_0TC_CCFG_uCaptureModeJpEG
    ...
    {0x002A, 0x0374}, {0x0F12, 0x0000}, //#REG_0TC_CCFG_uClockInd
    ...
    {0x002A, 0x038A}, {0x0F12, 0x0800}, //#REG_1TC_CCFG_usWidth
    ...
    {0x0F12, 0x0000}, {0x002A, 0x0244}, // REG_TC_GP_ActiveCapConfig
    {0x0F12, 0x0000}, {0x002A, 0x0240}, // REG_TC_GP_PrevOpenAfterChange
    {0x0F12, 0x0001}, {0x002A, 0x0230}, // REG_TC_GP_NewConfigSync
    {0x0F12, 0x0001}, {0x002A, 0x023E}, // REG_TC_GP_PrevConfigChanged
    {0x0F12, 0x0001}, {0x002A, 0x0246}, // REG_TC_GP_CapConfigChanged
    {0x0F12, 0x0001}, {0x002A, 0x0220},
    ...
    //==================================================================================
    {0x002A, 0x0DA0}, {0x0F12, 0x0005},

    {0x002A, 0x0D88}, {0x0F12, 0x0038}, {0x0F12, 0x0074}, {0x0F12, 0xFFF1},
    {0x0F12, 0x00BF}, {0x0F12, 0xFF9B}, {0x0F12, 0x00DB}, {0x0F12, 0xFF56},
    {0x0F12, 0x00F0}, {0x0F12, 0xFEFF}, {0x0F12, 0x010F}, {0x0F12, 0x0E74},
    {0x002A, 0x0DA8}, // awbb_OutdoorDetectionZone_ZInfo_m_MaxNB
    {0x0F12, 0x0BB8}, // awb is outdoor over (NB 3000d(BB8h))
    {0x002A, 0x0DA4}, {0x0F12, 0x274E},

    {0x002A, 0x0DCA}, {0x0F12, 0x0030},

    {0x002A, 0x3286}, {0x0F12, 0x0001}, // Pre/Post gamma on(ฟ๘บน)

    //===================================================================================
    // 18. ESD Check
    //===================================================================================
    {0x002A, 0x032C}, {0x0F12, 0xAAAA}, // ESD Check

    //===================================================================================
    // 19. Phone SW can do capture with several mode. (High, Normal, LowLux)
    //===================================================================================
    {0x002A, 0x032E}, {0x0F12, 0xFFFE}, // HighLux over this NB
    {0x0F12, 0x0000},
