...
static int global_current_shutter_speed = 0; //  0 do nothing; 1[2~3 fps];2[4~5
					     //  fps] ;3[6~7 fps];4 is  initial
					     //  setting[7~15 fps]
...
static struct msm_sensor_power_setting s5k5ca_power_setting[] = {
    ...
    {
	.seq_type = SENSOR_I2C_MUX, .seq_val = 0, .config_val = 0, .delay = 5,
    },
};
...
static struct msm_camera_i2c_reg_conf s5k5ca_best_shot[][70] = {
	...
	{0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x0B00}, {0x002A, 0x0530},
	{0x0F12, 0x3A98}, {0x0F12, 0x0000}, {0x0F12, 0x7EF4}, {0x0F12, 0x0000},
	{0x002A, 0x167C}, {0x0F12, 0x9C40}, {0x0F12, 0x0000}, {0x0F12, 0xF424},
	{0x0F12, 0x0000}, {0x002A, 0x0538}, {0x0F12, 0x3A98}, {0x0F12, 0x0000},
	{0x0F12, 0x7EF4}, {0x0F12, 0x0000}, {0x002A, 0x1684}, {0x0F12, 0x9C40},
	{0x0F12, 0x0000}, {0x0F12, 0xF424}, {0x0F12, 0x0000}, {0x002A, 0x0540},
	...
	{0x0028, 0x7000}, {0x002A, 0x023C}, {0x0F12, 0x0000}, {0x002A, 0x0240},
	{0x0F12, 0x0001}, {0x002A, 0x0230}, {0x0F12, 0x0001}, {0x002A, 0x023E},
...
{0x0F12, 0x0000},{0x0028, 0x7000},{0x002A, 0x0222},{0x0F12, 0x0001},
	...
	{0x002A, 0x0530}, {0x0F12, 0x3415}, {0x002A, 0x0534}, {0x0F12, 0x682A},
	{0x002A, 0x167C}, {0x0F12, 0x8235}, {0x002A, 0x1680}, {0x0F12, 0x1A80},
	{0x0F12, 0x0006}, {0x002A, 0x0538}, {0x0F12, 0x3415}, {0x002A, 0x053C},
	{0x0F12, 0x682A}, {0x002A, 0x1684}, {0x0F12, 0x8235}, {0x002A, 0x1688},
	{0x0F12, 0x1A80}, {0x0F12, 0x0006}, {0x002A, 0x0540}, {0x0F12, 0x0180},
	{0x0F12, 0x0250}, {0x002A, 0x168C}, {0x0F12, 0x0340}, {0x0F12, 0x0820},
	{0x002A, 0x0544}, {0x0F12, 0x0100}, {0x0F12, 0x0800}, {0x002A, 0x04B4},
	{0x0F12, 0x0000}, {0x0F12, 0x0000}, {0x0F12, 0x0001}, {0x0028, 0x7000},
	{0x002A, 0x023C}, {0x0F12, 0x0002}, {0x002A, 0x0240}, {0x0F12, 0x0001},
	...
	{0xFCFC, 0xD000}, {0x0028, 0x7000}, {0x002A, 0x020C}, {0x0F12, 0x0000},
	{0x002A, 0x0210}, {0x0F12, 0x0000}, {0x0F12, 0x0000}, {0xfcfc, 0xd000},
	{0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x2000}, {0x002A, 0x0530},
	{0x0F12, 0x36B0}, {0x002A, 0x0534}, {0x0F12, 0x36B0}, {0x002A, 0x167C},
	{0x0F12, 0x36B0}, {0x002A, 0x1680}, {0x0F12, 0x36B0}, {0x002A, 0x0538},
	{0x0F12, 0x36B0}, {0x002A, 0x053C}, {0x0F12, 0x36B0}, {0x002A, 0x1684},
	{0x0F12, 0x36B0}, {0x002A, 0x1688}, {0x0F12, 0x36B0}, {0x002A, 0x0540},
...
static struct msm_camera_i2c_reg_conf s5k5ca_iso[][37] = {
    {// ISO auto
     {0xfcfc, 0xd000}, {0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x0B00},
     {0x002A, 0x0530}, {0x0F12, 0x3A98}, {0x0F12, 0x0000}, {0x0F12, 0x7EF4},
     {0x0F12, 0x0000}, {0x002A, 0x167C}, {0x0F12, 0x9C40}, {0x0F12, 0x0000},
     {0x0F12, 0xF424}, {0x0F12, 0x0000}, {0x002A, 0x0538}, {0x0F12, 0x3A98},
     {0x0F12, 0x0000}, {0x0F12, 0x7EF4}, {0x0F12, 0x0000}, {0x002A, 0x1684},
     {0x0F12, 0x9C40}, {0x0F12, 0x0000}, {0x0F12, 0xF424}, {0x0F12, 0x0000},
     {0x002A, 0x0540}, {0x0F12, 0x0170}, {0x0F12, 0x0250}, {0x002A, 0x168C},
     {0x0F12, 0x0380}, {0x0F12, 0x0800}, {0x002A, 0x0544}, {0x0F12, 0x0100},
     {0x0F12, 0x0800}, {0x002A, 0x04B4}, {0x0F12, 0x0000}, {0x0F12, 0x0000},
     {0x0F12, 0x0001}},
    {// iso 100
     {0xfcfc, 0xd000}, {0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x1800},
     {0x002A, 0x0530}, {0x0F12, 0xC350}, {0x002A, 0x0534}, {0x0F12, 0xC350},
     {0x002A, 0x167C}, {0x0F12, 0xC350}, {0x002A, 0x1680}, {0x0F12, 0xc350},
     {0x002A, 0x0538}, {0x0F12, 0xC350}, {0x002A, 0x053C}, {0x0F12, 0xC350},
     {0x002A, 0x1684}, {0x0F12, 0xC350}, {0x002A, 0x1688}, {0x0F12, 0xC350},
     {0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
     {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
     {0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0096},
     {0x0F12, 0x0001}},
    {// iso 200
     {0xfcfc, 0xd000}, {0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x2000},
     {0x002A, 0x0530}, {0x0F12, 0xC350}, {0x002A, 0x0534}, {0x0F12, 0xC350},
     {0x002A, 0x167C}, {0x0F12, 0xC350}, {0x002A, 0x1680}, {0x0F12, 0xc350},
     {0x002A, 0x0538}, {0x0F12, 0xC350}, {0x002A, 0x053C}, {0x0F12, 0xC350},
     {0x002A, 0x1684}, {0x0F12, 0xC350}, {0x002A, 0x1688}, {0x0F12, 0xC350},
     {0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
     {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
     {0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x00C8},
     {0x0F12, 0x0001}},
    {// iso400
     {0xfcfc, 0xd000}, {0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x3000},
     {0x002A, 0x0530}, {0x0F12, 0xC350}, {0x002A, 0x0534}, {0x0F12, 0xC350},
     {0x002A, 0x167C}, {0x0F12, 0xC350}, {0x002A, 0x1680}, {0x0F12, 0xc350},
     {0x002A, 0x0538}, {0x0F12, 0xC350}, {0x002A, 0x053C}, {0x0F12, 0xC350},
     {0x002A, 0x1684}, {0x0F12, 0xC350}, {0x002A, 0x1688}, {0x0F12, 0xC350},
     {0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
     {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
     {0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0190},
     {0x0F12, 0x0001}},
    {
	// iso 800
	{0xfcfc, 0xd000}, {0x0028, 0x7000}, {0x002A, 0x12B8}, {0x0F12, 0x4000},
	{0x002A, 0x0530}, {0x0F12, 0xC350}, {0x002A, 0x0534}, {0x0F12, 0xC350},
	{0x002A, 0x167C}, {0x0F12, 0xC350}, {0x002A, 0x1680}, {0x0F12, 0xc350},
	{0x002A, 0x0538}, {0x0F12, 0xC350}, {0x002A, 0x053C}, {0x0F12, 0xC350},
	{0x002A, 0x1684}, {0x0F12, 0xC350}, {0x002A, 0x1688}, {0x0F12, 0xC350},
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0320},
	{0x0F12, 0x0001},
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0640},
	{0x0F12, 0x0001},
    },
    {
	// iso 300
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x012c},
	{0x0F12, 0x0001},
    },
    {
	// iso 900
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0384},
	{0x0F12, 0x0001},
    },
    {
	// iso500
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x01F4},
	{0x0F12, 0x0001},
    },
    {
	// iso600
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x0258},
	{0x0F12, 0x0001},
    },
    {
	// iso 700
	...
	{0x002A, 0x0540}, {0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x168C},
	{0x0F12, 0x0200}, {0x0F12, 0x0200}, {0x002A, 0x0544}, {0x0F12, 0x0100},
	{0x0F12, 0x8000}, {0x002A, 0x04B4}, {0x0F12, 0x0001}, {0x0F12, 0x02BC},
	{0x0F12, 0x0001},
    },
...
static struct msm_camera_i2c_reg_conf s5k5ca_capture_normal_mode_settings[] = {
    ...
    {0x0028, 0x7000}, {0x002A, 0x0244},
    {0x0F12, 0x0000},			// REG_TC_GP_ActiveCapConfig
    {0x002A, 0x0230}, {0x0F12, 0x0001}, // REG_TC_GP_NewConfigSync
    {0x002A, 0x0246}, {0x0F12, 0x0001}, // REG_TC_GP_CapConfigChanged
    {0x002A, 0x0224}, {0x0F12, 0x0001}, // REG_TC_GP_EnableCapture
    {0x0028, 0xD000}, {0x002A, 0xB0A0},
    {0x0F12, 0x0000}, // Clear cont. clock befor config change
    {0x0028, 0x7000}, {0x002A, 0x0226},
...
CDBG("Peter: gpio:%d value:%d %s",gpio_req[i].gpio,gpio_get_value(gpio_req[i].gpio),gpio_req[i].label);
	...
	if (power_setting->config_val) {
		...
		//= name;
		s_ctrl->clk_info[power_setting->seq_val].delay =
		    power_setting->delay;
		s_ctrl->clk_info[power_setting->seq_val].clk_rate =
		    power_setting->config_val;
	}
	pr_info("%s: %d: clk_rate = [%ld], clk_info_size = [%d]\n", __func__,
		__LINE__, s_ctrl->clk_info[power_setting->seq_val].clk_rate,
...
int32_t s5k5ca_shutter_speed_switch(struct msm_sensor_ctrl_t *s_ctrl,
				    int sut_speed)
{
	long rc = 0;
	...
	if (sut_speed != 0) {
		...
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x002a, 0x037A,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0f12, max_value,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0f12, min_value,
		    MSM_CAMERA_I2C_WORD_DATA);
	}
			     ...
			     void __user *argp)
{
	...
	case CFG_SET_INIT_SETTING:
		...
		// Reset
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0010, 0x0001,
		    MSM_CAMERA_I2C_WORD_DATA);
		// Clear host interrupt so main will wait
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x1030, 0x0000,
		    MSM_CAMERA_I2C_WORD_DATA);
		// ARM go
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0014, 0x0001,
		    MSM_CAMERA_I2C_WORD_DATA);
		usleep(10000);
		sensor_state = 0;
#if 1
		...
		pr_info("%s: %d: sensor write init setting!\n", __func__,
			__LINE__);
#else
		pr_err("%s: %d: sensor write init setting move to "
	...
	case CFG_SET_RESOLUTION:
		...
		if (*((int *)(cdata->cfg.setting)) == 1) {
			...
			rc |=
				...
				s_ctrl->sensor_i2c_client, 0x002a, 0x0F70,
				MSM_CAMERA_I2C_WORD_DATA);
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x0f12, 0x0048,
				MSM_CAMERA_I2C_WORD_DATA);
			msleep(50);
			if (night_mode_capture_flag) {
				...
				rc =
					...
					->i2c_write_conf_tbl(
					    s_ctrl->sensor_i2c_client,
					    s5k5ca_capture_normal_mode_settings,
					    ARRAY_SIZE(
						s5k5ca_capture_normal_mode_settings),
					    MSM_CAMERA_I2C_WORD_DATA);
			}
	...
	case CFG_SET_STOP_STREAM:
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    ...
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x002a, 0x0220,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0f12, 0x0000,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
...
//			sensor_state = 1;
	...
	case CFG_SET_SLAVE_INFO: {
		...
		for (slave_index = 0; slave_index < power_setting_array->size;
		     slave_index++) {
	...
	case CFG_POWER_UP:
		...
		global_current_shutter_speed =
		    0; //  0 do nothing; 1[2~3 fps];2[4~5 fps] ;3[6~7 fps];4 is
		       //  initial setting[7~15 fps]
	...
	case CFG_SET_WHITE_BALANCE: {
		...
		rc =
		    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client,
			s5k5ca_wb_oem[*((int *)(cdata->cfg.setting))],
	...
	case CFG_SET_BESTSHOT_MODE: { /*
		...
		if (reduce_party_cloudy_flag) {
			...
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x002a, 0x04D2,
				MSM_CAMERA_I2C_WORD_DATA);
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		...
		else if ((*((int *)(cdata->cfg.setting))) == 3) // SNOW
		{
			bestshot = 7;
			brightness_value =
			    global_current_brightness_state + U_EV_2;
			Ev_feature = 1;
		...
		} else if ((*((int *)(cdata->cfg.setting))) == 4) // BEACH
		{
			bestshot = 0;
			brightness_value =
			    global_current_brightness_state + U_EV_1;
			Ev_feature = 1;
		...
		if (Ev_feature) {
			...
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x002a, 0x020C,
				MSM_CAMERA_I2C_WORD_DATA);
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x0F12,
				(brightness_value * 10),
				MSM_CAMERA_I2C_WORD_DATA);
		} else {
			...
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x0F12,
				(global_current_brightness_state * 10),
				MSM_CAMERA_I2C_WORD_DATA);
		}
		//***********************Ev_setting--******************************
		...
		if (iso_feature) {
			...
			rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl
				  ->i2c_write_conf_tbl(
				      s_ctrl->sensor_i2c_client,
				      s5k5ca_iso[global_current_iso_state],
	...
	case CFG_SET_ISO: {
		...
		rc =
			...
			s5k5ca_iso_size[iso], MSM_CAMERA_I2C_WORD_DATA);
		rc =
		    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write_conf_tbl(
			s_ctrl->sensor_i2c_client, s5k5ca_preview_settings,
			ARRAY_SIZE(s5k5ca_preview_settings),
	...
	case CFG_SET_BRIGHTNESS: {
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x0F12, (brightness * 10),
		    MSM_CAMERA_I2C_WORD_DATA);
	...
	case CFG_GET_SHUTTER:
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    ...
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x002E, 0x1A44,
		    MSM_CAMERA_I2C_WORD_DATA);
		...
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    ...
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x002E, 0x1A46,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_read(
	...
	case CFG_GET_GAIN:
		rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    ...
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
		    s_ctrl->sensor_i2c_client, 0x002E, 0x23EC,
		    MSM_CAMERA_I2C_WORD_DATA);
		rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_read(
		    s_ctrl->sensor_i2c_client, 0x0F12, &lchipid,
		    MSM_CAMERA_I2C_WORD_DATA);
	...
	case CFG_SET_AUTO_BESTSHOT_MODE: {
		/*
		  ...
		  SCENE_BACKLIGHT_PORTRAIT,//MORPHO_SCENE_DETECTOR_SCENE_BACKLIGHT_PORTRAIT
		  = 4,
		  SCENE_NIGHT,//MORPHO_SCENE_DETECTOR_SCENE_NIGHT = 5,
		  SCENE_NIGHT_PORTRAIT,//MORPHO_SCENE_DETECTOR_SCENE_NIGHT_PORTRAIT
		  = 6,
		...
		if (global_current_brightness_state != bv) {
			...
			rc |=
			    s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
				s_ctrl->sensor_i2c_client, 0x0F12, (bv * 10),
				MSM_CAMERA_I2C_WORD_DATA);
		}
...
int32_t s5k5ca_match_id(struct msm_sensor_ctrl_t *s_ctrl)
{
	...
	rc = s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
	    ...
	    MSM_CAMERA_I2C_WORD_DATA);
	rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
	    s_ctrl->sensor_i2c_client, 0x002c, 0x0000,
	    MSM_CAMERA_I2C_WORD_DATA);
	rc |= s_ctrl->sensor_i2c_client->i2c_func_tbl->i2c_write(
	    s_ctrl->sensor_i2c_client, 0x002e, 0x0040,
	    MSM_CAMERA_I2C_WORD_DATA);
